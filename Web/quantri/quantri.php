    ...
    <body>
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="quantri.php"><span>KB-MOBILE</span> Admin</a>
                    <ul class="user-menu">
        ...
        <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
            ...
            <ul class="nav menu">
                ...
                <li class="parent ">
                    <a href="quantri.php?page_layout=kho">
                        <span data-toggle="collapse" href="#sub-item-6"><svg class="glyph stroked chevron-down"><use xlink:href="#stroked-chevron-down"></use></svg></span> Quản lý kho
                    </a>
                    <ul class="children collapse" id="sub-item-6">
                        <li>
                            <a class="" href="#">
                                <svg class="glyph stroked plus sign"><use xlink:href="#stroked-plus-sign"/></svg> Chỉnh sửa kho
                            </a>
                        </li>
                ...
                <li class="parent ">
                    <a href="quantri.php?page_layout=donhang">
                        <span data-toggle="collapse" href="#sub-item-7"><svg class="glyph stroked chevron-down"><use xlink:href="#stroked-chevron-down"></use></svg></span> Quản lý đơn hàng
                    </a>
                    <ul class="children collapse" id="sub-item-7">
                        <li>
                            <a class="" href="quantri.php?page_layout=chitietdonhang">
                                <svg class="glyph stroked plus sign"><use xlink:href="#stroked-plus-sign"/></svg> Chi tiết đơn hàng
                            </a>
                        </li>
                ...
                if(isset($_GET['page_layout'])){
                    switch ($_GET['page_layout']) {
                        ...
                        case 'thongtin': include_once'./chucnang/thanhvien/thongtin.php';
                            break;
                        case 'kho': include_once'./chucnang/kho/dskho.php';
                            break;
                        case 'donhang': include_once'./chucnang/donhang/dsdonhang.php';
                            break;
                        case 'chitietdonhang': include_once'./chucnang/donhang/chitietdonhang.php';
                            break;
                        case 'thongtindh': include_once'./chucnang/donhang/thongtindh.php';
                            break;
                        case 'indonhang': include_once'./chucnang/donhang/indonhang.php';
                            break;
                        case 'suadonhang': include_once'./chucnang/donhang/suadonhang.php';
                            break;
                        case 'thongtinsp': include_once'./chucnang/donhang/thongtinsp.php';
                            break;
                        case 'suachitietdonhang': include_once'./chucnang/donhang/suachitietdonhang.php';
                            break;
                        case 'suakho': include_once'./chucnang/kho/suakho.php';
                            break;
                        case 'chitietdm': include_once'./chucnang/danhmuc/chitietdm.php';
                            break;
