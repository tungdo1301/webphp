<?php  
    ...
    if(isset($_POST['submit'])){
        ...
        if(isset($ten_sp) && isset($gia_sp) && isset($bao_hanh) && isset($phu_kien) && 
                ...
                isset($chi_tiet_sp) && isset($dac_biet) &&isset($ton_kho)){
            ...
            $sql="UPDATE sanpham SET ten_sp='$ten_sp',gia_sp='$gia_sp',bao_hanh='$bao_hanh',khuyen_mai='$khuyen_mai',"
                    ...
                    . "chi_tiet_sp='$chi_tiet_sp', dac_biet='$dac_biet',anh_sp='$anh_sp',ton_kho='$ton_kho',id_dm='$id_dm' WHERE id_sp=$id_sp";
            $query= mysqli_query($conn, $sql);
                ...
                <form method="post" enctype="multipart/form-data" role="form">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="ton_kho" value="<?php if(isset($_POST['ton_kho'])){echo $_POST['ton_kho'];}else{echo $row['ton_kho'];} ?>" required="">
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label>Hãng sản xuất (danh mục)</label>
