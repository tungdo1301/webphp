<?php  
    ...
    if(isset($_POST['submit'])){
        ...
        if (isset($ten_sp) && isset($gia_sp) && isset($bao_hanh) && isset($phu_kien) && isset($tinh_trang) && isset($khuyen_mai) && isset($trang_thai) && isset($chi_tiet_sp) && isset($anh_sp) && isset($id_dm) && isset($dac_biet)&& isset($ton_kho)) {
            move_uploaded_file($tmp_name, 'anh/'.$anh_sp);
            $sql="INSERT INTO sanpham(ten_sp,gia_sp,bao_hanh,phu_kien,tinh_trang,khuyen_mai,trang_thai,chi_tiet_sp,anh_sp,id_dm,dac_biet,ton_kho) VALUES('$ten_sp','$gia_sp','$bao_hanh','$phu_kien','$tinh_trang','$khuyen_mai','$trang_thai','$chi_tiet_sp','$anh_sp','$id_dm','$dac_biet','$ton_kho')";
...
<div class="row">
    <ol class="breadcrumb">
        ...
        <li><a href="quantri.php?page_layout=danhsachsp">Danh sách sản phẩm</a></li>
        <li class="active"></li>
    </ol>
</div><!--/.row-->
            ...
            <div class="panel-body">
                ...
                <form method="post" enctype="multipart/form-data" role="form">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label>Só lượng sản phẩm trong kho</label>
                            <input type="text" class="form-control" name="ton_kho" value="" required="">
                        </div>
                        <div class="form-group">
